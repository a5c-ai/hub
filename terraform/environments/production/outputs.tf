...
output "application_gateway_fqdn" {
  ...
  value       = module.security.public_ip_fqdn
}
...
output "backup_storage_connection_string" {
  description = "The connection string for the backup storage account"
  value       = module.backup_storage.primary_connection_string
  sensitive   = true
}
